...
public abstract class LazyLob<T> {
	...
	protected LazyLob(SessionImplementor session, Object owner, String name, LobType<T> lobType) {
	...
	protected static Configuration getConfiguration() {
		LocalSessionFactoryBean fb = getBean("&sessionFactory", LocalSessionFactoryBean.class);
